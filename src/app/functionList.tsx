"use client";
import { Accordion, AccordionDetails, AccordionSummary, Autocomplete, Card, TextField, Typography } from "@mui/material";
...
const data = 
        ...
        {
            "description": "Get blueprint explosion",
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "description": "Only show sell if FALSE, only show buy if TRUE, both if left empty",
            ...
            "parameters": [
                ...
                {
                    "description": "Latest data only, changes the entity to only display the latest data point",
                    "name": "latest_only",
                    "type": "boolean",
                    "optional": true
                }
