export const function_data = [
    ...
    },
    {
        ...
        "parameters": [
            ...
            {
                "description": "(String) Type name to filter results by or type id number to strict filter out by.  Also accepts group_id:X,Y,Z to display only items matching the group id. or type_id:A,B,C. These custom filters must be entered as a string",
    ...
    },
    {
        ...
        "parameters": [
            ...
            {
                "description": "Type name as string to filter results by or type id number to strict filter out by.  Also accepts group_id:X,Y,Z to display only items matching the group id. or type_id:A,B,C. These custom filters must be entered as a string",
                "name": "type_name_or_type_id",
                "optional": true,
                "type": "any"
            },
