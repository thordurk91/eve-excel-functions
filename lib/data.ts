export const function_data = [
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "description": "Show agents, default FALSE",
                    "name": "show_agents",
                    "optional": true,
                    "type": "boolean"
                }
        ...
        {
            "description": "Get route between solarsystems by parameters.",
            "id": "ROUTE",
            "name": "ROUTE",
            "parameters": [
                {
                    "description": "Origin solarystem id",
                    "name": "origin",
                    "type": "number"
                },
                {
                    "description": "Destination solarystem id",
                    "name": "destination",
                    "type": "number"
                },
                {
                    "description": "Route type flag, secure, insecure, shortest. Default is shortest",
                    "name": "flag",
                    "optional": true,
                    "type": "string"
                },
                {
                    "description": "Solarsystems to avoid, array of integers",
                    "name": "avoid",
                    "optional": true,
                    "type": "any"
                }
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "description": "(String) Type name to filter results by or type id number to strict filter out by. category, group, type_id list searching can be done with 'category_id: 6,7' exclude with '!category_id: 6,7', replace category_id with group_id or type_id for other filtering logic.",
        ...
        {
            "description": "Get corporation projects",
            "id": "CORPORATION_PROJECTS",
            "name": "CORPORATION_PROJECTS",
            "parameters": [
                {
                    "description": "The character id or entity.",
                    "name": "character_id_or_entity",
                ...
                {
                    "description": "Fetch all projects, not just active ones. Default = false",
                    "name": "state",
                    "optional": true,
                    "type": "boolean"
                }
        ...
        {
            "description": "Get corporation projects",
            "id": "CORPORATION_PROJECT",
            "name": "CORPORATION_PROJECT",
            "parameters": [
                {
                    "description": "The Project id (UUID format)",
                    "name": "project_id",
                    "type": "string"
                },
                {
        ...
        },
        {
            ...
            "parameters": [
                {
                    "description": "The character id or entity. If omitted, mining ledger for the first signed in character will be returned",
                    "name": "character_id_or_entity",
                    "optional": true,
                    "type": "any"
                }
        ...
        },
        {
            ...
            "parameters": [
                ...
                {
                    "description": "Status or type to filter by, string, exact match. Seperated by ,",
